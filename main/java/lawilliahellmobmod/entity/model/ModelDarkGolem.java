...
public class ModelDarkGolem extends ModelBase
{
    ...
    public ModelDarkGolem(){
        this(0.0F);
    }

    public ModelDarkGolem(float p_i1161_1_){
        this(p_i1161_1_, -7.0F);
    }

    public ModelDarkGolem(float p_i1162_1_, float p_i1162_2_)
    {
        short short1 = 128;
        short short2 = 128;
    ...
    {
    	EntityDarkGolem entity = (EntityDarkGolem)p_78086_1_;
        ...
        if (i > 0){
            ...
            int j = entity.getHoldTNTTick();

            if (j > 10 && j <= 20 * 5){
                this.ironGolemRightArm.rotateAngleX = -2.0F + 0.025F * this.func_78172_a((float)j, 70.0F);
