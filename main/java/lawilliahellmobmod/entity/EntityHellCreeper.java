...
import lawilliahellmobmod.entity.ai.EntityAIHellCreeperSwell;
...
public class EntityHellCreeper extends EntityMob{
	/**
    ...
    public EntityHellCreeper(World world){
        super(world);
        this.isImmuneToFire = true;
        this.setSize(0.8F, 0.625F);
        this.stepHeight = 2.6F;
        this.experienceValue = 5;

        this.tasks.addTask(1, new EntityAISwimming(this));
        this.tasks.addTask(2, new EntityAIHellCreeperSwell(this)); //変更
        this.tasks.addTask(3, new EntityAIAvoidEntity(this, EntityOcelot.class, 6.0F, 1.0D, 1.2D));
        this.tasks.addTask(3, new EntityAIAvoidEntity(this, EntityDarkGolem.class, 4.0F, 1.0D, 1.5D));
        this.tasks.addTask(4, new EntityAIAttackOnCollide(this, EntityFlouncingSquid.class, 1.5D, false));
        ...
        this.targetTasks.addTask(4, new EntityAINearestAttackableTarget(this, EntityFlouncingSquid.class, 0, false));
        this.targetTasks.addTask(4, new EntityAINearestAttackableTarget(this, EntityNetherWitch.class, 0, false));
        this.targetTasks.addTask(5, new EntityAINearestAttackableTarget(this, EntityVillager.class, 0, false));
    }
